    ...
    privacyPolicy: (
      <div>
        ...
        <ol type="i">
          <li>
            ...
            <p>
              ...
              are the "Services” for visitors and users ("you" and/or "your"). </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              European Union and provided by contabo (https://contabo.com/). </p>
          </li>
          <li>
            ...
            <p>
              ...
              information about parents, children, and childcare groups. </p>
            <ul>
              <li>
                <p>
                  &bull; About parents: name, family name, phone number,
                  address, email and picture/avatar. </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  information about when and how you use the Services. </p>
              </li>
            </ul>
            <p>
              ...
              providing them for the purposes of the Services. </p>
          </li>
          <li>
            ...
            <p>
              ...
              cancellation of her/his account. </p>
            <p>
              ...
              for the studies and the publications. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              or in the good faith belief that such action is necessary to: </p>
            <ul>
              <li>
              ...
              <li>
                <p>
                  ...
                  safety of users of the Services or the public </p>
              </li>
              <li>
          ...
          <li>
            ...
            <p>
              ...
              to use certain Families_Share Services. </p>
          </li>
          <li>
            ...
            <p>
              ...
              parents and data are collected according to the GDRP (article 8): </p>
            <ul>
              <li>
                <p>
                  ...
                  by the holder of parental responsibility over the child. </p>
              </li>
              <li>
                <p>
          ...
          <li>
            ...
            <p>
              ...
              and certifications required by the GDPR. </p>
            <p>
            ...
            <p>
              ...
              for one year (365 days) will be fully deleted. </p>
            <p>
            ...
            <p>
              ...
              Parliament Directive 2002/58/EC. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              the platform itself, as described above (V.) </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              SSL-based protocol. </p>
            <p>
              It is your responsibility to properly protect the access to the
              device where the app is installed against unauthorized usage. </p>
            <p>
              ...
              sure do not share them with anyone else. </p>
          </li>
          <li>
            ...
            <p>
              ...
              all information relevant to their account. </p>
            <p>
              ...
              further processing should have disappeared. </p>
            <p>
              You may also email us at contact@families-share.eu to request that
              we delete your personal information from our database. </p>
          </li>
          <li>
        ...
        <p>
          ...
          and agree to the Privacy Policy above </p>
      </div>
    ),
    accept: 'ACCEPT'
  },
...
const nl = {
    ...
    privacyPolicy: (
      <div>
        ...
        <p>
          ...
          gegevens kan updaten, managen, exporteren en verwijderen. </p>
        <ol type="i">
          <li>
            ...
            <p>
              ...
              de “diensten” voor bezoekers en gebruikers (“u” en/of “uw”). </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              tot de diensten of bepaalde diensten gebruikt. </p>
            <p>
              In het bijzonder zal in het Families_Share platform informatie
              worden verzameld over ouders, kinderen en kinderopvanggroepen. </p>
            <ul>
              <li>
                <p>
                  &bull; Over ouders: naam, achternaam, telefoonnummer, adres,
                  e-mailadres en foto / avatar. </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  de groepsfeed (tekst & afbeelding). </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  over wanneer en hoe u de diensten gebruikt. </p>
              </li>
            </ul>
            <p>
              ...
              verstrekt voor de doeleinden van de diensten. </p>
          </li>
          <li>
            <h2>
              Ons gebruik van uw persoonlijke gegevens en andere informatie </h2>
            <p>
              ...
              aan het hele consortium voor onderzoeksdoeleinden. </p>
            <p>
            ...
            <p>
              ...
              worden bewaard als bewijs voor de studies en publicaties. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              dergelijke actie noodzakelijk is om: </p>
            <ul>
              <li>
            ...
            <ul>
              <li>
                <p>
                  ...
                  van de ouderlijke verantwoordelijkheid voor het kind. </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  overeenkomst met betrekking tot een kind. " </p>
              </li>
            </ul>
            <p>
              ...
              dienst waarvoor het wordt verstrekt ". </p>
          </li>
          <li>
            <h2>Kinderen</h2>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              practices en beschikbare normen. </p>
            <p>
            ...
            <p>
              ...
              wordt opnieuw opgeslagen in datacenters in de EU </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              platform zelf worden gebruikt, zoals hierboven beschreven (V.) </p>
            <p>
              ...
              apps die op hetzelfde apparaat zijn geïnstalleerd. </p>
          </li>
          <li>
            <h2>Veiligheid</h2>
            <p>
            ...
            <p>
              ...
              vertrouwelijk houden ervan. Deel ze met niemand anders. </p>
          </li>
          <li>
            ...
            <p>
              ...
              wettelijke basis voor verdere verwerking had moeten verdwijnen. </p>
            <p>
              U kunt ons ook e-mailen op contact@families-share.eu om te vragen
              dat wij uw persoonlijke gegevens uit onze database verwijderen. </p>
          </li>
          <li>
        ...
        <p>
          ...
          begrepen en ga akkoord met het bovenstaande privacybeleid </p>
      </div>
    ),
    accept: 'ACCEPTEER'
  },
  ...
  groupActivities: {
    ...
    surveysHeader: 'In afwachting van onderzoek',
  ...
  reviewCard: {
    ...
    pastTimeMark: '%s geleden',
    futureTimeMark: 'in %s',
    aFewSeconds: 'een paar seconden',
    aMinute: 'een minuut',
    xMinutes: '%d minuten',
    anHour: 'een uur',
    xHours: '%d uur',
...
const it = {
    ...
    privacyPolicy: (
      <div>
        ...
        <p>
          ...
          aggiornare, gestire, esportare ed eliminare le tue informazioni. </p>
        <ol type="i">
          <li>
            ...
            <p>
              ...
              Web, sono i "Servizi" per visitatori e utenti ("tu" e/o "tuo"). </p>
            <p>
            ...
            <ul>
              <li>
                <p>
                  ...
                  telefono, indirizzo, e-mail e immagine/avatar. </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  mobile compresi) o altri eventuali dettagli tecnici compresi. </p>
              </li>
              <li>
                <p>
                  &bull; Dettagli sull'utilizzo dei nostri servizi: informazioni
                  sulle metriche su quando e come vengono utilizzati i servizi. </p>
              </li>
            </ul>
            <p>
          ...
          <li>
            <h2>
              L'uso che facciamo dei tuoi dati personali e altre informazioni </h2>
            <p>
              ...
              dell'intero consorzio a fini della ricerca. </p>
            <p>
              ...
              fine del progetto come prova per gli studi e le pubblicazioni. </p>
            <p>
          ...
          <li>
            <h2>
              La divulgazione dei tuoi dati personali e altre informazioni </h2>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              essere possibile accedere a determinati servizi Families_Share. </p>
          </li>
          <li>
            ...
            <p>
              ...
              vengono raccolti secondo le normative del GDPR (articolo 8): </p>
            <ul>
              <li>
                <p>
          ...
          <li>
            ...
            <p>
              ...
              eliminare tali informazioni dai nostri database. </p>
          </li>
          <li>
            ...
            <p>
              ...
              giorni) verranno completamente cancellati. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              all'interno della piattaforma stessa, come descritto sopra (V.) </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              protocollo https basato su SSL. </p>
            <p>
            ...
            <p>
              ...
              riservati. Non devono essere comunicati a nessuno. </p>
          </li>
          <li>
            ...
            <p>
              ...
              al ricorso giurisdizionale effettivo. </p>
            <p>
            ...
            <p>
              ...
              per ulteriore trattamento viene a cessare. </p>
            <p>
              ...
              personali dal nostro database. </p>
          </li>
          <li>
            ...
            <p>
              ...
              parti interessate ne riceveranno apposita notifica. </p>
          </li>
          <li>
            <h2>Comunicazione</h2>
            <p>
              Per qualsiasi altra informazione sul nostro conto siete pregati di
              visitare il nostro sito Web: https://www.families-share.eu/ </p>
            <p>
              ...
              dei Servizi. Puoi contattarci a: contact@families-share.eu </p>
          </li>
          <li>
        ...
        <p>
          ...
          accetta l'informativa sulla privacy di cui sopra </p>
      </div>
    ),
    accept: 'ACCETTA'
  },
  ...
  groupActivities: {
    ...
    surveysHeader: 'Sondaggi in sospeso',
  ...
  reviewCard: {
    ...
    pastTimeMark: '%s fa',
    futureTimeMark: 'tra %s',
    aFewSeconds: 'qualche secondo',
    aMinute: 'un minuto',
    xMinutes: '%d minuti',
    anHour: 'un\'ora',
    xHours: '%d ore',
...
const el = {
    ...
    privacyPolicy: (
      <div>
        ...
        <ol type="i">
          ...
          <li>
            ...
            <p>
              ...
              και παρέχονται από τη Contabo (https://contabo.com/). </p>
          </li>
          <li>
            ...
            <p>
              ...
              ή χρησιμοποιείτε ορισμένες Υπηρεσίες. </p>
            <p>
            ...
            <ul>
              <li>
                <p>
                  ...
                  αριθμό τηλεφώνου, διεύθυνση, email και εικόνα / avatar. </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  μηνύματα στην ομάδας (κείμενο και εικόνα). </p>
              </li>
              <li>
                <p>
            ...
            <p>
              ...
              παρέχετε για τους σκοπούς των Υπηρεσιών. </p>
          </li>
          <li>
            ...
            <p>
              ...
              κοινοπραξία για ερευνητικούς σκοπούς. </p>
            <p>
              ...
              απόδειξη για τις μελέτες και τις δημοσιεύσεις. </p>
            <p>
          ...
          <li>
            <h2>
              Η αποκάλυψη των προσωπικών σας δεδομένων και άλλων πληροφοριών </h2>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              δεδομένα συλλέγονται δεδομένα σύμφωνα με το GDRP (άρθρο 8): </p>
            <ul>
              <li>
                <p>
                  ...
                  εγκρίνεται από τον κάτοχο της γονικής μέριμνας. </p>
              </li>
              <li>
                <p>
                  ...
                  μέριμνας, λαμβανομένης υπόψη της διαθέσιμης τεχνολογίας. </p>
              </li>
              <li>
                <p>
          ...
          <li>
            ...
            <p>
              ...
              διαγράψουμε αυτές τις πληροφορίες από τις βάσεις δεδομένων μας. </p>
          </li>
          <li>
            ...
            <p>
              ...
              αποθηκεύεται ξανά σε κέντρα δεδομένων στην ΕΕ </p>
            <p>
            ...
            <p>
              ...
              πρόσβαση στον φάκελο δεδομένων. </p>
          </li>
          <li>
            ...
            <p>
              ...
              στην ίδια πλατφόρμα, όπως περιγράφεται παραπάνω (V.) </p>
            <p>
              ...
              εγκατεστημένες στην ίδια συσκευή. </p>
          </li>
          <li>
            <h2>Ασφάλεια</h2>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              σχετίζονται με τον λογαριασμό τους. </p>
            <p>
              ...
              βάση για περαιτέρω επεξεργασία θα έπρεπε να έχει εξαφανιστεί. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              την ιστοσελίδα μας: https://www.families-share.eu/ </p>
            <p>
        ...
        <p>
          ...
          και συμφωνώ με τη Πολιτική προστασίας Προσωπικών Δεδομένων. </p>
      </div>
    ),
    accept: 'ΑΠΟΔΟΧΗ'
  },
  ...
  groupActivities: {
    ...
    surveysHeader: 'Εκκρεμείς έρευνες',
  ...
  reviewCard: {
    ...
    pastTimeMark: '%s πριν',
    futureTimeMark: 'σε %s',
    aFewSeconds: 'μερικά δευτερόλεπτα',
    aMinute: 'ένα λεπτό',
    xMinutes: '%d λεπτά',
    anHour: 'μία ώρα',
    xHours: '%d ώρες',
...
const hu = {
    ...
    privacyPolicy: (
      <div>
        ...
        <p>
          ...
          kezelheti, exportálhatja és törölheti adatait. </p>
        <ol type="i">
          <li>
          ...
          <li>
            ...
            <p>
              ...
              projekt Adatfeldolgozója és Adatkezelője. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              által biztosított szervereken tárolódnak. </p>
          </li>
          <li>
            ...
            <p>
              ...
              hozzáférés érdekében, illetve egyes Szolgáltatások használatával. </p>
            <p>
              A Families_Share platform adatokat gyűjt különösen a szülőkről, a
              gyermekekről és a gyermekgondozói csoportokról gyűjt adatokat. </p>
            <ul>
              <li>
                <p>
                  &bull; A szülőkről gyűjtött adatok: családi és utónév,
                  telefonszám, lakcím, email cím és fotó/avatar. </p>
              </li>
              <li>
                <p>
                  ...
                  speciális étrend, speciális szükségletek, stb.). </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  értelmezhetők; és egyéb technikai részletekről. </p>
              </li>
              <li>
                <p>
            ...
            <p>
              ...
              nekünk azok feldolgozására is. </p>
          </li>
          <li>
            ...
            <p>
              ...
              teljes konzorcium számára elérhetővé válik kutatási célokra. </p>
            <p>
              ...
              adminisztrátorának jóváhagyásától függ. </p>
            <p>
              ...
              az esetben személyes adatok nem kerülnek gyűjtésre). </p>
          </li>
          <li>
            ...
            <p>
              ...
              olyan esetben, ha ez feltétlen szükséges: </p>
            <ul>
              <li>
                <p>
          ...
          <li>
            ...
            <p>
              ...
              bizonyos Szolgáltatásait nem fogja tudni használni. </p>
          </li>
          <li>
            <h2>Adatgyűjtés</h2>
            <p>
              ...
              Rendeletnek (8. cikk) megfelelően történik: </p>
            <ul>
              <li>
                <p>
                  ...
                  szülői felügyeletet gyakorló adta meg, illetve engedélyezte. </p>
              </li>
              <li>
                <p>
                  ...
                  felügyeleti jog gyakorlója adta meg, illetve engedélyezte. </p>
              </li>
              <li>
                <p>
          ...
          <li>
            ...
            <p>
              ...
              adatok törlésre kerüljenek az adatbázisunkból. </p>
          </li>
          <li>
            ...
            <p>
              ...
              belül található adatközpontokban tárolnak el. </p>
            <p>
            ...
            <p>
              ...
              (kezelési és karbantartási céllal) férnek hozzá az adattárolóhoz. </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              hozzáféréssel szemben, amelyre az alkalmazást telepíti. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              bírósági jogorvoslattal éljen. </p>
            <p>
            ...
            <p>
              ...
              adatkezelés jogalapja megszűnik. </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              az érintett felek erről külön értesítést is kapnak. </p>
          </li>
          <li>
            <h2>Kommunikáció</h2>
            <p>
              Velünk kapcsolatos további információk elérése érdekében, kérjük,
              látogassa meg honlapunkat: https://www.families-share.eu/ </p>
            <p>
        ...
        <p>
          ...
          és elfogadja a fenti adatvédelmi irányelveket </p>
      </div>
    ),
    accept: 'ELFOGAD'
  },
  ...
  groupActivities: {
    ...
    surveysHeader: 'Függőben lévő felmérések',
  ...
  reviewCard: {
    ...
    organizer: 'Menedzser',
    pastTimeMark: '%s két',
    futureTimeMark: 'két %s',
    aFewSeconds: 'néhány másodperc',
    aMinute: 'egy perc',
    xMinutes: '%d percek',
    anHour: 'egy óra',
    xHours: '%d órák',
...
const fr = {
  ...
  'privacyPolicyModal': {
    'privacyPolicy': (
      <div>
        ...
        <p>
          Cette politique de confidentialité a pour but de vous aider à comprendre quelles informations nous
          recueillons, pourquoi nous les collectons et comment vous pouvez mettre à jour, gérer, exporter et supprimer
          vos informations. </p>
        <ol type="i">
          <li>
            <h2>Politique de confidentialité de Families_Share</h2>
            <p>
              Bienvenue sur le site web (le « site ») de Families_Share. Ce Site a été développé pour fournir des
              informations sur les services de Families_Share. L'application Families_Share, avec le site web, sont les
              « services » pour les visiteurs et les utilisateurs (« vous » et/ou « votre »). </p>
            <p>
              Cette politique de confidentialité définit la politique de Families_Share en ce qui concerne vos
              informations, y compris les informations qui vous identifient ou pourraient vous identifier
              personnellement (appelées « informations personnelles identifiables » aux États-Unis ou « données
              personnelles » dans l'Union européenne, que nous appellerons « données personnelles ») et d'autres
              informations collectées auprès des visiteurs et utilisateurs des Services.
              Veuillez lire attentivement cette politique de confidentialité afin que vous compreniez comment nous
              traiterons vos données. En utilisant l'un de nos services, vous confirmez avoir lu, compris et accepté
              cette politique de confidentialité. Si vous n'acceptez pas cette politique, veuillez ne pas utiliser les
              services. Si vous avez des questions, veuillez nous envoyer un courriel à
              <bold> contact@families-share.eu </bold>
            </p>
          </li>
          <li>
            ...
            <p>
              Nous sommes ViLabs, le partenaire du projet de l'UE, Families_Share, responsable pour le développement et
              la maintenance du site Web et des applications Families_Share et des services correspondants, et aussi
              responsable du traitement et du contrôle des données du dit projet.
              ViLabs CY (“Versatile Innovations”), ECASTICA Business centre 6, Vasili Vryonides str. Gala Court
              Chambers, Limassol, Chypre t. +30 2310 365 188, +35 725 760 967, <bold> info@vilabs.eu </bold>.Nous
              appelons cette équipe « ViLabs », « nous » et/ou « notre ».
            </p>
          </li>
          <li>
            <h2>Notre statut juridique et les lois applicables en matière de confidentialité des données</h2>
            <p>
              ViLabs assume le rôle de responsable du traitement et du contrôle des données en vertu de la législation
              de l'UE. Toutes les données à caractère personnel sont collectées, utilisées, stockées et traitées en
              pleine conformité avec le règlement général sur la protection des données (règlement (UE) 679/2016
              également connu sous le nom de « RGPD ») et la directive 2002/58/CE du Parlement européen (directive sur
              la vie privée et les communications électroniques). Seuls les chercheurs Vilabs et les administrateurs
              système auront accès au répertoire de données. Les services Families_Share sont hébergés sur des serveurs
              situés dans l'Union européenne et fournis par Contabo (https://contabo.com/). </p>
          </li>
          <li>
            <h2>Informations que nous recueillons</h2>
            <p>
              Lorsque vous interagissez avec nous par le biais des services, nous recueillons des données personnelles
              et autres informations vous concernant, comme décrit ci-dessous :

              Nous recueillons des données personnelles auprès de vous lorsque vous fournissez volontairement de telles
              informations, par exemple lorsque vous nous contactez pour des demandes de renseignements, vous vous
              inscrivez pour accéder aux services ou vous utilisez certains des services.

            </p>
            <p>
              En particulier, dans la plate-forme Families_Share sont recueillies des informations sur les parents, les
              enfants et les groupes de garde d'enfants. </p>
            <ul>
              <li>
                <p>
                  &bull; Concernant les parents : prénom, nom de famille, numéro de téléphone, adresse, e-mail et
                  photo/avatar. </p>
              </li>
              <li>
                <p>
                  &bull; Concernant les enfants : les informations sont collectées uniquement par ceux qui exercent la
                  responsabilité parentale, et ils ont le droit de fournir les informations pertinentes, conformément à
                  la législation applicable. Ces informations sont : nom, date de naissance, sexe, photo/avatar et
                  autres informations directement spécifiées par les parents (allergies, maladies, régime alimentaire
                  spécifique, besoins spéciaux, etc.). </p>
              </li>
              <li>
                <p>
                  &bull; Concernant les groupes de garde d'enfants : le nom du groupe, la biographie du groupe,
                  l'emplacement de la garde d'enfants, les périodes de garde d'enfants et les messages du flux de groupe
                  (texte et images). </p>
              </li>
              <li>
                <p>
                  &bull; Détails techniques ou autres concernant tout appareil que vous utilisez pour accéder aux
                  services, y compris l'identifiant unique de périphérique (UDID) ou équivalent de l'appareil ; votre
                  système d'exploitation, type de navigateur ou autre logiciel ; les détails de votre matériel ou de
                  votre appareil mobile (y compris le type et le numéro de votre appareil mobile et les informations de
                  votre opérateur mobile), s'il y a lieu ; ou d'autres détails techniques. </p>
              </li>
              <li>
                <p>
                  &bull; Détails de votre utilisation de nos services : informations statistiques sur le moment et la
                  façon dont vous utilisez les services. </p>
              </li>
            </ul>
            <p>
              En nous fournissant volontairement des données personnelles, vous consentez à ce que nous les utilisions
              dans le cadre des services et conformément à la présente politique de confidentialité (art. 6, par. 1,
              let. a, RGPD). Accessoirement, le traitement des données personnelles doit également être conforme à la
              loi lorsqu'il est nécessaire à l'exécution des services (art. 6, par. 1, let. b, RGPD). En ce qui concerne
              les catégories particulières de données personnelles, vous donnez votre consentement explicite au
              traitement de ces données dès leur communication aux fins des services. </p>
          </li>
          <li>
            <h2>Notre utilisation de vos données personnelles et autres informations</h2>
            <p>
              Toute information recueillie est immédiatement séparée en (i) une partie contenant des informations
              personnelles (non sensibles) (telles que le nom, l'adresse électronique, le numéro de téléphone, etc.) sur
              les participants concernés et (ii) une partie entièrement anonymisée (non identifiable) puis mise à la
              disposition de l'ensemble du consortium à des fins de recherche. </p>
            <p>
              Les données personnelles des participants à chaque CityLab seront partagées via l'application aux autres
              membres du groupe pour la gestion des activités Families_Share, sous le contrôle de l'administrateur du
              groupe. Tout abus de la part d'un membre entraînera l'annulation de son compte. Notez que toute demande
              d'adhésion à un groupe est soumise à l'approbation de l'administrateur du groupe. </p>
            <p>
              Des données personnelles supplémentaires des participants seront collectées si nécessaire et uniquement à
              des fins scientifiques (par exemple, pour élargir les contacts pour des études longitudinales) et seront
              supprimées immédiatement après l'achèvement du projet. Les données anonymisées sont stockées dans un dépôt
              partagé et seront conservées après l'achèvement du projet comme preuves pour les études et les
              publications. </p>
            <p>
              En particulier, les services peuvent utiliser ces informations et les mettre en commun avec d'autres
              informations sur une base anonyme et généralisée pour suivre, par exemple, le nombre total d'utilisateurs
              de nos services, le nombre de visiteurs de chaque page de notre site et les noms de domaine des
              fournisseurs de services Internet de nos visiteurs (aucune donnée personnelle est concernée dans ce
              cas). </p>
          </li>
          <li>
            <h2>Notre divulgation de vos données personnelles informations supplémentaires</h2>
            <p>
              Dans tous les cas, Families_Share (et donc le partenaire responsable ViLabs) ne peut divulguer vos données
              personnelles que si la loi l'exige ou en croyant de bonne foi qu'une telle action est nécessaire pour
              : </p>
            <ul>
              <li>
              ...
              <li>
                <p>
                  &bull; Agir en cas d'urgence pour protéger la sécurité personnelle des utilisateurs des services ou du
                  public </p>
              </li>
              <li>
          ...
          <li>
            <h2>Vos choix</h2>
            <p>
              Vous pouvez visiter les services sans fournir de données personnelles. Si vous choisissez de ne pas
              fournir de données Personnelles, il se peut que vous ne puissiez pas utiliser certains services de
              Families_Share. </p>
          </li>
          <li>
            <h2>Recueil des données </h2>
            <p>
              Toutes les données proviennent des utilisateurs qui s'inscrivent à la plate-forme Families_Share. La
              plupart du temps, les parents doivent donner leur consentement au traitement d'informations privées et «
              sensibles » sur leurs enfants. En particulier, les informations concernant les enfants sont fournies par
              les parents et les données sont recueillies es conformément au RGPD (article 8) : </p>
            <ul>
              <li>
                <p>
                  &bull; Lorsque l'article 6, paragraphe 1, point a, s'applique, en ce qui concerne l'offre de services
                  de la société d'information directement à un enfant, le traitement des données à caractère personnel
                  d'un enfant est légal lorsque l'enfant est âgé d'au moins 16 ans. Lorsque l'enfant est âgé de moins de
                  16 ans, ce traitement n'est légal que si et dans la mesure où le titulaire de la responsabilité
                  parentale de l'enfant autorise ou donne son consentement. </p>
              </li>
              <li>
                <p>
                  &bull; Dans de tels cas, le contrôleur doit faire des efforts raisonnables pour vérifier que le
                  titulaire de la responsabilité parentale de l'enfant autorise ou donne son consentement, en tenant
                  compte de la technologie disponible. </p>
              </li>
              <li>
                <p>
                  &bull; Le paragraphe 1 n'affecte pas le droit général des contrats des États membres, notamment les
                  règles relatives à la validité, à la formation ou à l'effet d'un contrat à l'égard d'un enfant </p>
              </li>
            </ul>
            <p>
              Rappelez-vous également le point 32 du RGPD : « Le consentement doit être donné par un acte affirmatif
              clair établissant une indication librement donnée, spécifique, éclairée et sans ambiguïté de l'accord de
              la personne concernée quant au traitement des données personnelles la concernant, par exemple par une
              déclaration écrite, y compris par des moyens électroniques, ou une déclaration orale. Cela pourrait
              inclure la coche d'une case lors de la visite d'un site Internet, le choix des paramètres techniques pour
              les services relatifs à la société de l'information ou une autre déclaration ou comportement indiquant
              clairement dans ce contexte l'acceptation par la personne concernée du traitement proposé de ses données
              personnelles [...] Si le consentement de la personne concernée doit être donné à la suite d'une demande
              par voie électronique, la demande doit être claire, concise et ne pas perturber inutilement l'utilisation
              du service pour lequel elle est fournie ». </p>
          </li>
          <li>
            <h2>Enfants</h2>
            <p>
              Families_Share ne collecte pas sciemment les données personnelles fournies par les enfants de moins de 16
              ans. Si vous avez moins de 16 ans, veuillez ne pas fournir de données personnelles par le biais des
              services. Nous encourageons les parents et les tuteurs légaux à surveiller l'utilisation d'Internet de
              leurs enfants et à contribuer à l'application de notre politique de confidentialité en demandant à leurs
              enfants de ne jamais fournir de données personnelles sur les services sans leur autorisation. Si vous avez
              des raisons de croire qu'un enfant de moins de 16 ans a fourni des données personnelles à Families_Share
              par le biais des services, veuillez nous contacter et nous nous efforcerons de supprimer ces informations
              de nos bases de données. </p>
          </li>
          <li>
            <h2>Stratégie de stockage et de protection des données </h2>
            <p>
              L'ensemble des services Families_Share sont proposés via le cloud, et les parties frontale et dorsale de
              la plateforme ainsi que les données sont stockées sur des serveurs dédiés sécurisés et protégés par
              l'intermédiaire d'un fournisseur de cloud certifié, qui dispose de toutes les infrastructures et
              certifications requises par le RGPD. </p>
            <p>
              Le fournisseur de services cloud est géré par une personne responsable de VILABS et un responsable de la
              protection des données (Prof. Agostino Cortesi, Universita Ca'Foscari Venezia, cortesi@unive.it), suivant
              les meilleures pratiques et normes disponibles. </p>
            <p>
              Les données personnelles seront stockées tout au long du cycle de vie officiel du projet Families_Share
              financé par le programme de l'UE Horizon 2020 (jusqu'au 31/10/2020). Après la fin de la période officielle
              du projet, les données personnelles des utilisateurs qui ne se sont pas connectés à leur compte depuis un
              an (365 jours) seront entièrement supprimées. </p>
            <p>
              L'installation de stockage protégé du fournisseur de services cloud sera basée sur des systèmes redondants
              et située dans l'UE. Les données sont sauvegardées quotidiennement et une copie de sauvegarde est
              également stockée dans les centres de données de l'UE </p>
            <p>
              L'accès aux données sur le stockage est soumis à une authentification au moyen d'un nom d'utilisateur et
              d'un mot de passe gérés conformément à la directive 2002/58/CE du Parlement européen. </p>
            <p>
              Seuls les chercheurs VILabs (à des fins de recherche) et les administrateurs système (à des fins de
              maintenance) auront accès au dossier de données. </p>
          </li>
          <li>
            <h2>Partage de données avec des tiers</h2>
            <p>
              Aucun des renseignements personnels recueillis ne sera partagé avec des tiers. Les informations collectées
              ne seront utilisées que dans la plate-forme elle-même, comme décrit ci-dessus (V.) </p>
            <p>
              L'application ne fait pas usage de l'utilisation d'« intentions » implicites. Cela empêche l'accès
              inapproprié aux données par d'autres applications installées sur le même appareil. </p>
          </li>
          <li>
            <h2>Sécurité</h2>
            <p>
              ViLabs prend des mesures raisonnables pour protéger les données personnelles fournies via les services
              contre la perte, l'utilisation abusive et l'accès non autorisé, la divulgation, l'altération ou la
              destruction. La communication de données depuis/vers l'utilisateur sera gérée via le protocole SSL
              https. </p>
            <p>
              Il est de votre responsabilité de protéger correctement l'accès à l'appareil sur lequel l'application est
              installée contre toute utilisation non autorisée. </p>
            <p>
              Les utilisateurs enregistrés Families_Share disposent d'un nom d'utilisateur et d'un identifiant unique,
              ce qui vous permet d'accéder à certaines parties de nos services. Vous êtes responsable de les garder
              confidentiels. Assurez-vous de ne pas les partager avec quelqu'un d'autre. </p>
          </li>
          <li>
            <h2>Vos droits - Fermeture de votre compte </h2>
            <p>
              La législation de l'UE sur la protection des données donne aux citoyens de l'UE le droit d'accéder aux
              informations les concernant. Ces informations sont mentionnées ci-dessus et peuvent être modifiées par
              vous via les services, conformément au RGPD (art. 15-22). En outre, vous avez le droit de rectification,
              le droit de retirer le consentement donné (lorsque le consentement est la base légale du traitement des
              données à caractère personnel), le droit d'effacement (« droit à l'oubli »), le droit de restreindre le
              traitement, le droit à la portabilité des données, le droit de s'opposer au traitement, le droit de ne pas
              faire l'objet d'une décision fondée sur un traitement automatisé (y compris le profilage), le droit de
              déposer une plainte auprès d'une autorité de contrôle, le droit à un recours judiciaire effectif. </p>
            <p>
              Vous pouvez nous envoyer un e-mail à contact@families-share.eu </p>
            <p>
              Tous les utilisateurs peuvent modifier leurs informations personnelles comme ils le souhaitent, avoir
              accès et peuvent télécharger une copie de leurs informations et de leur participation à des activités via
              l'application Families_Share, tout en ayant le droit de supprimer complètement leur compte et toutes les
              informations relatives à leur compte. </p>
            <p>
              À la suite de l'annulation du compte par l'utilisateur, sauf dans le cas de données anonymes, il y a une
              obligation de supprimer les données à caractère personnel dès que possible, puisque la base légale pour le
              traitement ultérieur doit avoir disparu. </p>
            <p>
              Vous pouvez également nous envoyer un e-mail à contact@families-share.eu pour nous demander de supprimer
              vos informations personnelles de notre base de données. </p>
          </li>
          <li>
            <h2>Modification de la politique de confidentialité</h2>
            <p>
              Cette politique de confidentialité peut changer de temps à autre. Lorsque des modifications sont
              apportées, la date d'entrée en vigueur indiquée ci-dessous changera également en conséquence, et la
              nouvelle politique de confidentialité sera publiée en ligne, tandis que toutes les parties concernées
              recevront une notification spécifique. </p>
          </li>
          <li>
            <h2>Communication </h2>
            <p>
              Pour toute autre information à notre sujet, veuillez visiter notre site web :
              https://www.families-share.eu/ </p>
            <p>
              N'hésitez pas à nous contacter si vous avez des questions concernant la politique de confidentialité de
              Families_Share ou les pratiques en matière d'information des services. Vous pouvez nous contacter en
              envoyant un e-mail à l’adresse contact@families-share.eu </p>
          </li>
          <li>
            <h2>Gestion des données</h2>
            <p>
              DPO: Coordinateur du projet Prof. Agostino Cortesi, Universita Ca'Foscari
        ...
        <p>
          Je confirme que j'ai lu, compris et accepte la politique de confidentialité ci-dessus (veuillez cocher la case
          adjacente) </p>
      </div>
    ),
    'accept': 'ACCEPTER'
  ...
  'groupActivities': {
    ...
    'surveysHeader': 'Enquête en attente',
